    ...
    <div>
      ...
      >
        ...
        <div className="absolute bottom-[60px] left-0 right-0 h-1.5 flex">
          ...
          <div className="flex-1" style={{ backgroundColor: '#FACC15' }} />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              <Link
                to="/shop"
                className="inline-flex items-center gap-2 bg-white px-6 py-3 rounded-full hover:bg-blue-50 transition-colors"
                style={{ fontFamily: 'Nunito, sans-serif', fontWeight: 800, color: '#2563EB' }}
              >
              ...
              <Link
                to="/sounds"
                className="inline-flex items-center gap-2 border-2 border-white/40 text-white px-6 py-3 rounded-full hover:bg-white/10 transition-colors"
          ...
          <div className="hidden lg:flex justify-center items-center">
            <div className="relative">
              ...
              <div
                ...
                style={{
                  background: 'linear-gradient(135deg, #EF4444, #FACC15, #22C55E, #2563EB)',
                  opacity: 0.6,
                }}
              />
              <div className="relative w-80 h-80 rounded-3xl overflow-hidden shadow-2xl">
                <ImageWithFallback
                  src="https://images.unsplash.com/photo-1598088372329-26b2932afa98?w=800"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="mb-10">
            <h2
              ...
              style={{ fontFamily: 'Fredoka, sans-serif', fontSize: '2rem', fontWeight: 600 }}
            >
              What we carry
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {categories.map((cat) => (
              ...
              >
                ...
                <span
                  className={`inline-flex items-center gap-1 text-sm ${cat.textClass}`}
                  style={{ fontFamily: 'Nunito, sans-serif', fontWeight: 700 }}
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <div className="relative">
              ...
              <p
                className="mb-6"
                style={{ fontFamily: 'Nunito, sans-serif', lineHeight: 1.7, color: '#713F12' }}
              >
              ...
              <Link
                to="/shop"
                className="inline-flex items-center gap-2 bg-white px-6 py-3 rounded-full hover:bg-yellow-50 transition-colors"
                style={{ fontFamily: 'Nunito, sans-serif', fontWeight: 800, color: '#CA8A04' }}
              >
                <ShoppingBag className="w-4 h-4" />
                Go to shop
              </Link>
            ...
            {testimonials.map((t) => (
              ...
              >
                <p
                  ...
                  style={{ fontFamily: 'Nunito, sans-serif', fontStyle: 'italic' }}
                >
                  "{t.quote}"
                </p>
                <div>
          ...
          >
            ...
            <div className="relative p-8 sm:p-12 grid grid-cols-1 sm:grid-cols-2 gap-8 items-center">
              <div>
                ...
                >
                  Stream our library of Arabic kids' praise tracks and show music directly in your
                  browser. No downloads required.
                </p>
                <Link
                  to="/sounds"
                  className="inline-flex items-center gap-2 bg-white px-6 py-3 rounded-full hover:bg-green-50 transition-colors"
                  style={{ fontFamily: 'Nunito, sans-serif', fontWeight: 800, color: '#16A34A' }}
                >
                  <Music className="w-4 h-4" />
                  Open sounds
                </Link>
