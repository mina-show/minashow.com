    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center px-4">
          ...
          >
            <ShoppingBag className="w-10 h-10" style={{ color: "#202973" }} />
          </div>
          <h2
          ...
          <Link
            to="/shop"
            className="inline-flex items-center gap-2 text-white px-6 py-3 rounded-full transition-colors hover:opacity-90 font-sans font-extrabold"
            ...
            {items.map((item) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-gray-500 text-sm capitalize font-sans">
                    {item.category}
                  </p>
                  <p className="text-gray-900 mt-1 font-sans font-extrabold">
                    ${item.price}
                  </p>
                </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6 sticky top-20">
              ...
              <div className="flex flex-col gap-3 mb-6">
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-700 text-sm font-sans font-semibold">
                    ${total}
                  </span>
                </div>
                <div className="flex justify-between">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 text-white py-3 rounded-full transition-colors hover:opacity-90 font-sans font-extrabold"
                style={{ backgroundColor: "#202973" }}
              >
                Proceed to checkout
              ...
              >
                <p className="text-xs leading-relaxed font-sans" style={{ color: "#92400E" }}>
